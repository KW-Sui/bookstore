										...
										<tr>
											...
											<td class="tableopentd03">
												...
												<c:if test="${order.payState==0 }">
													<a href="${pageContext.request.contextPath}/client/user/delOrderById?id=${order.id}">刪除</a>
												</c:if> 
												<c:if test="${order.payState!=0 }">
													<a href="${pageContext.request.contextPath}/client/user/delOrderById?id=${order.id}&flag=1">刪除</a>
												</c:if>
											</td>
										</tr>
									</c:forEach>
