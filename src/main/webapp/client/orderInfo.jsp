						...
						<tr>
							<td>
								<table width="100%" border="0" cellspacing="0">
									<tr>
										<td>
											<p>订单编号:${orderItems[0].order.id}</p>
										</td>
									</tr>
									<tr>
										<td>
											...
											<table cellspacing="1" class="carttable">
												<tr>
													<td style="text-align:right; padding-right:40px;"><font
														style="color:#FF0000">合计：&nbsp;&nbsp;${orderItems[0].order.money}</font>
													</td>
												</tr>
											</table>
											<p>
												收货地址：${orderItems[0].order.receiverAddress }&nbsp;&nbsp;&nbsp;&nbsp;<br />
												收货人：&nbsp;&nbsp;&nbsp;&nbsp;${orderItems[0].order.receiverName }&nbsp;&nbsp;&nbsp;&nbsp;<br />
												联系方式：${orderItems[0].order.receiverPhone }&nbsp;&nbsp;&nbsp;&nbsp;
											</p>
											<hr>
											<c:if test="${orderItems[0].order.payState != 1 }">
											<p style="text-align:right">
												<a href="${pageContext.request.contextPath}/client/orders/aliPay?id=${orderItems[0].order.id}&money=${orderItems[0].order.money}">
