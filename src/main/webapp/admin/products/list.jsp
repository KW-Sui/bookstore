...
<body>
	...
	<form id="Form1" name="Form1"
		action="${pageContext.request.contextPath}/admin/product/findProductByManyCondition"
		method="post">
							...
							<tr>
								...
								<td class="ta_01" bgColor="#ffffff"><select name="category"
									id="category">
										...
										<option value="科技" <c:if test="${product.category == '科学'}">selected</c:if>>科技</option>
							...
							<c:forEach items="${products}" var="p">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="${pageContext.request.contextPath}/admin/product/findProductById?id=${p.id}">
											<img
									...
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="${pageContext.request.contextPath}/admin/product/removeProduct?id=${p.id}">
											<img
