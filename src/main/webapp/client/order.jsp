...
<%@ taglib prefix="loginTag" uri="http://yyf.login-tags" %>
		...
		<table width="100%" border="0" cellspacing="0">
			<tr>
				...
				<td><div style="text-align:right; margin:5px 10px 5px 0px">
					...
					<form id="orderForm" action="${pageContext.request.contextPath}/client/orders/createOrder" method="post">
						<table cellspacing="0" class="infocontent">
							<tr>
								<td><table width="100%" border="0" cellspacing="0">
										<tr>
											<td><img src="images/buy2.gif" width="635" height="38" />
												<p>你好，${login_user.username}！欢迎您来到网上书城结算中心</p>
											</td>
										</tr>
										<tr>
											<td><table cellspacing="1" class="carttable">
												...
												<p>
													...
													<br /> 收货人：&nbsp;&nbsp;&nbsp;&nbsp;<input
														name="receiverName" type="text" value="${login_user.username}"
														style="width:150px" />&nbsp;&nbsp;&nbsp;&nbsp;<a href="#"></a>
													<br /> 联系方式：<input type="text" name="receiverPhone"
														value="${login_user.telephone}" style="width:150px" />&nbsp;&nbsp;&nbsp;&nbsp;<a
														href="#"></a>
