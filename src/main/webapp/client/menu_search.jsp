...
<div id="divmenu">
		...
		<a href="${pageContext.request.contextPath}/client/product/findProductByCategory?category=经营">经营</a>
	...
	<table width="100%" border="0" cellspacing="0">
		<tr>
			<td style="text-align:right; padding-right:220px">
				Search 
				<input type="text" name="textfield" class="inputtable" id="textfield" value="${name==null?'请输入书名':name}"
